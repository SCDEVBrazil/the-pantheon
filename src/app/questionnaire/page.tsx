      ...
      <main className="relative z-10">
        <section className="min-h-screen flex items-center justify-center px-6 sm:px-8 lg:px-12 xl:px-16 pt-20">
          <div className="w-full max-w-6xl mx-auto">
            ...
            {/* Gradient Divider */}
            <div className="h-0.5 bg-gradient-to-r from-gray-300 via-gray-400 to-transparent w-full mb-16 opacity-60"></div>

            {/* Questionnaire Section */}
            <div className="bg-gray-900/20 rounded-3xl overflow-hidden">
              <div className="bg-black p-8 lg:p-12">
                <div className="mb-8 text-center">
                  <div className="w-16 h-1 bg-gray-400 mb-4 mx-auto"></div>
                  <p className="text-gray-400 uppercase tracking-wider text-sm font-semibold mb-2">FOUNDING MEMBER ASSESSMENT</p>
                </div>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-black mb-8 tracking-tight text-center">
                ...
                <div className="bg-gray-800/30 rounded-xl p-8 mb-8 max-w-4xl mx-auto">
                  ...
                  <form className="space-y-8" onSubmit={handleSubmit}>
                    ...
                    {currentStep === 2 && (
                      <div className="step-section">
                        <h3 className="text-xl font-bold text-white mb-6">Project Resonance</h3>
                    ...
                    {currentStep === 3 && (
                      <div className="step-section">
                        <h3 className="text-xl font-bold text-white mb-6">Your Interests</h3>
                    ...
                    {currentStep === 4 && (
                      <div className="step-section">
                        <h3 className="text-xl font-bold text-white mb-6">Your Approach</h3>
                    ...
                    {currentStep === 5 && (
                      <div className="step-section">
                        <h3 className="text-xl font-bold text-white mb-6">Your Vision</h3>
                    ...
                    {currentStep === 6 && (
                      <div className="step-section">
                        <h3 className="text-xl font-bold text-white mb-6">Systems Analysis</h3>
