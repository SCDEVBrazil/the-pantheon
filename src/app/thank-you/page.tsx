...
export const metadata: Metadata = {
  title: 'Application Submitted Successfully | Pantheon Chicago Intellectual Salon',
  description: 'Your founding member application has been successfully submitted. We will review your application and contact you with details about Chicago\'s first intellectual salon.',
  robots: {
    index: false, // Don't index this confirmation page
    follow: true,
  },
  openGraph: {
    title: 'Application Submitted Successfully | Pantheon',
    description: 'Your founding member application has been successfully submitted. We will be in touch soon about the Chicago intellectual salon.',
    url: 'https://www.thepantheon.club/thank-you',
    type: 'website',
  },
  twitter: {
    card: 'summary',
    title: 'Application Submitted Successfully | Pantheon',
    description: 'Your founding member application has been successfully submitted.',
  },
  alternates: {
    canonical: 'https://www.thepantheon.club/thank-you',
  },
}
...
export default function ThankYou() {
  const structuredData = {
    ...
    "description": "Confirmation page for successful Pantheon founding member application submission",
    "url": "https://www.thepantheon.club/thank-you",
    "mainEntity": {
    ...
    "breadcrumb": {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "Confirmation",
          "item": "https://www.thepantheon.club/thank-you"
        }
      ]
    }
  }
        ...
        <main className="relative z-10">
          <section className="min-h-screen flex items-center justify-center px-6 sm:px-8 lg:px-12 xl:px-16 pt-20">
            <div className="w-full max-w-4xl mx-auto text-center">
              ...
              {/* Success Icon */}
              <div className="mb-12">
                <div className="w-24 h-24 bg-gradient-to-br from-gray-700 to-gray-900 rounded-full flex items-center justify-center mx-auto mb-8 border border-gray-600" role="img" aria-label="Success checkmark">
              ...
              <div className="mb-16">
                ...
                <p className="text-xl md:text-2xl text-gray-400 font-light max-w-3xl mx-auto leading-relaxed mb-8">
                  Your founding member application has been successfully submitted
                </p>
              </div>

              {/* Gradient Divider */}
              <div className="h-0.5 bg-gradient-to-r from-white via-gray-400 to-transparent w-full mb-16 opacity-60 max-w-2xl mx-auto" role="separator" aria-hidden="true"></div>

              {/* What Happens Next */}
              <section className="mb-16" aria-labelledby="next-steps">
                <div className="mb-6">
                  <div className="w-16 h-1 bg-white mb-4 mx-auto" aria-hidden="true"></div>
                  <p className="text-gray-400 uppercase tracking-wider text-sm font-semibold mb-2">WHAT HAPPENS NEXT</p>
                </div>
                <h2 id="next-steps" className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-white leading-tight">
              ...
              <aside className="bg-gray-900/30 rounded-2xl p-8 lg:p-10 border border-gray-700/50 backdrop-blur-md max-w-2xl mx-auto mb-16" aria-labelledby="meantime-heading">
                <h3 id="meantime-heading" className="text-2xl font-bold text-white mb-6">In the Meantime</h3>
              ...
              {/* Back to Home */}
              <nav className="text-center mb-20">
                <Link href="/" aria-label="Return to homepage">
                  <button className="group relative bg-gradient-to-r from-gray-800 to-black text-white font-bold py-4 px-8 rounded-full text-lg hover:from-gray-700 hover:to-gray-900 transition-all duration-300 transform hover:scale-105 shadow-2xl border border-gray-700" type="button">
