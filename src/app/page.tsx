...
export const metadata: Metadata = {
  title: 'Join Chicago\'s First Intellectual Salon | Pantheon - Systems Thinkers Unite',
  description: 'Join Chicago\'s premier intellectual salon for systems thinkers. Move beyond surface conversations to rigorous analysis and collaborative solutions. Apply for founding membership now.',
  keywords: [
    'chicago intellectual salon',
    'systems thinking chicago',
    'intellectual community',
    'critical thinking group',
    'founding members',
    'collaborative problem solving',
    'chicago philosophy group',
    'intellectual discourse',
    'conscious evolution',
    'rigorous analysis'
  ],
  openGraph: {
    title: 'Join Chicago\'s First Intellectual Salon | Pantheon',
    description: 'Join Chicago\'s premier intellectual salon for systems thinkers. Move beyond surface conversations to rigorous analysis and collaborative solutions.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Chicago Intellectual Salon - Join Systems Thinkers at Pantheon',
      }
    ],
  },
  twitter: {
    ...
    title: 'Join Chicago\'s First Intellectual Salon | Pantheon',
    description: 'Join Chicago\'s premier intellectual salon for systems thinkers. Move beyond surface conversations to rigorous analysis.',
...
export default function Home() {
  const structuredData = {
    ...
    "@type": "Organization",
    "name": "Pantheon Chicago Intellectual Salon",
    "description": "Chicago's first intellectual salon for systems thinkers focused on rigorous analysis and collaborative solutions",
    "url": "https://www.thepantheon.club",
    ...
    "offers": {
      "@type": "Offer",
      "name": "Intellectual Salon Founding Membership",
      "description": "Exclusive founding membership for Chicago's first intellectual salon focused on systems thinking and collaborative problem-solving",
      "category": "Educational Program",
      "availability": "https://schema.org/LimitedAvailability"
    },
    "audience": {
      "@type": "Audience",
      "audienceType": "Systems Thinkers, Intellectuals, Critical Thinkers"
    },
    "event": {
      "@type": "Event",
      "name": "Chicago Intellectual Salon",
      "description": "Monthly meetings for rigorous intellectual discourse and collaborative problem-solving",
      "location": {
        "@type": "Place",
        "name": "Chicago",
        "address": {
          ...
          <div className="w-full px-6 sm:px-8 lg:px-12 xl:px-16">
            <div className="flex justify-between items-center py-6">
              ...
              <div className="flex items-center space-x-3">
                <svg viewBox="0 0 200 50" className="h-16 w-auto md:h-20" aria-label="Pantheon Logo">
                  <defs>
              ...
              <section className="mb-32 relative">
                <div className="text-center">
                  ...
                  <div className="text-center">
                    <Link 
                      href="/questionnaire"
                      aria-label="Apply for founding membership in Chicago's intellectual salon"
                    >
                      <button 
                        className="group relative bg-gradient-to-r from-gray-800 to-black text-white font-bold py-6 px-12 rounded-full text-xl lg:text-2xl hover:from-gray-700 hover:to-gray-900 transition-all duration-300 transform hover:scale-105 shadow-2xl border border-gray-700"
                        type="button"
                      >
